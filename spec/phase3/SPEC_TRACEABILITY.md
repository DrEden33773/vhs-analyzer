...
| CLI-012 | Targeted suggest triggering | `editors/code/src/extension.ts` | T-CLI-022, T-CLI-023, T-CLI-023A, T-CLI-024, T-CLI-024A (`editors/code/src/extension.test.ts`) | CMP-005, CMP-006, CMP-009 |
