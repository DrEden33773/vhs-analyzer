...
| CMP-005 | Theme name completions | P0 | `crates/vhs-analyzer-lsp/src/completion.rs` | T-CMP-030–T-CMP-035 + T-CMP-034A + T-CMP-034B + T-CMP-034C + T-CMP-034D + T-CMP-034E + T-CMP-034F | — | Completed |
...
| CMP-009 | Time unit completions | P2 | `crates/vhs-analyzer-lsp/src/completion.rs` | T-CMP-090–T-CMP-098 | — | Completed |
...
| DIA-014 | Unknown built-in theme name | P1 | `crates/vhs-analyzer-lsp/src/diagnostics/semantic.rs` | T-DIA-066–T-DIA-068 | PAR-007 (SetCommand) | Completed |
